module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      'title': ['splendid', 'ui-serif', 'Georgia', 'Cambria', '"Times New Roman"', 'Times', 'serif'],
      'mono': ['lucidaconsole', 'ui-monospace', 'SFMono-Regular', 'Menlo', 'Monaco', 'Consolas', '"Liberation Mono"', '"Courier New"', 'monospace'],
    },
    extend: {},
  },
  variants: {
